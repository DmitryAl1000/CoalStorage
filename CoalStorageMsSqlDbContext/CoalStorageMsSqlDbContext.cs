...
namespace MsSqlDbContext
{
    ...
    {
        public CoalStorageMsSqlDbContext()
        {
        ...
        public CoalStorageMsSqlDbContext(DbContextOptions<CoalStorageMsSqlDbContext> optionsBuilder) : base(optionsBuilder)
        {
            ...
            //Создаётся пустая локальная база данных, заполняется хардкодом. Имитация подключения к существующей базе данных
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Slot>(b => b.HasKey(e => e.SlotNumber));

            modelBuilder.Entity<Slot>().Property(x => x.SlotNumber).IsRequired(true);
            ...
            modelBuilder.Entity<Area>().Property(x => x.AreaId).IsRequired(true);
            ...
            modelBuilder.Entity<CargoHistory>().Property(x => x.AreaId).IsRequired(true);
